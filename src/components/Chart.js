...
const data = [
  ...
  { month: "Feb", price: Math.floor(Math.random()*750)+250},
  { month: "Mar", price: Math.floor(Math.random()*750)+250},
  { month: "Apr", price: Math.floor(Math.random()*750)+250},
  { month: "May", price: Math.floor(Math.random()*750)+250},
  { month: "Jun", price: Math.floor(Math.random()*750)+250},
  { month: "Jul", price: Math.floor(Math.random()*750)+250},
